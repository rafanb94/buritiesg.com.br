<?php 
$pageTitle = "Expertise no Mercado Financeiro | Buriti ESG"; 
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                  Expertise no Mercado Financeiro
                </h1>
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                ...
                <div class="bg-[#3E322D] rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition group">
                    <div class="h-48 bg-[#3E322D] flex items-center justify-center relative overflow-hidden">
                        ...
                        <div class="text-white text-6xl relative z-10"><img src="<?= BASE_URL ?>/imagens/conformidade-e-riscos-socioambientais.jpg
                        " alt="Atuação Estratégica" title="Atuação Estratégica"></div>
                    </div>
                    <div class="p-6 text-white">
                        <div class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center mb-4 text-lg font-bold">
                            E
                        </div>
                        <a href="<?= BASE_URL ?>/nossos-diferenciais/atuacao-estrategica"><h3 class="text-xl font-bold mb-2 group-hover:text-orange-400 transition">Atuação Estratégica</h3></a>
                    </div>
                </div>
                ...
                <div class="bg-[#3E322D] rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition group">
                    <div class="h-48 bg-[#3E322D] flex items-center justify-center relative overflow-hidden">
                        <div class="absolute inset-0 bg-black/20"></div>
                        <div class="text-white text-6xl relative z-10"><img src="<?= BASE_URL ?>/imagens/expertise-no-mercado-financeiro.jpg" alt="Expertise no Mercado Financeiro" title="Expertise no Mercado Financeiro"></div>
                    </div>
                    <div class="p-6 text-white">
                        <div class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center mb-4 text-lg font-bold">
                            S
                        </div>
                        <a href="<?= BASE_URL ?>/nossos-diferenciais/expertise-no-mercado-financeiro"><h3 class="text-xl font-bold mb-2 group-hover:text-orange-400 transition">Expertise no Mercado Financeiro</h3></a>
                    </div>
                </div>
                ...
                <div class="bg-[#3E322D] rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition group">
                    <div class="h-48 bg-[#3E322D] flex items-center justify-center relative overflow-hidden">
                        <div class="absolute inset-0 bg-black/20"></div>
                        <div class="text-white text-6xl relative z-10"><img src="<?= BASE_URL ?>/imagens/track-record-comprovado.jpg" alt="Track Record comprovado" title="Track Record comprovado"></div>
                    </div>
                    <div class="p-6 text-white">
                        <div class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center mb-4 text-lg font-bold">
                            G
                        </div>
                        <a href="<?= BASE_URL ?>/nossos-diferenciais/track-record-comprovado"><h3 class="text-xl font-bold mb-2 group-hover:text-orange-400 transition">Track Record comprovado</h3></a>
                    </div>
                </div>
            </div>
        </div>
