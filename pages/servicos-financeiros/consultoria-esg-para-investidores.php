<?php 
$pageTitle = "Consultoria ESG para Investidores | Buriti ESG"; 
...
?>
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl mx-auto text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                    Consultoria ESG para Investidores
                </h1>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                <!-- Card 1 -->
                <div class="bg-[#3E322D] rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition group">
                    <div class="h-48 bg-[#3E322D] flex items-center justify-center relative overflow-hidden">
                        <div class="absolute inset-0 bg-black/20"></div>
                        <div class="text-white text-6xl relative z-10"><img src="<?= BASE_URL ?>/imagens/produtos-financeiros-sustentaveis.jpg
                        " alt="Produtos Financeiros Sustentáveis" title="Produtos Financeiros Sustentáveis"></div>
                    </div>
                    <div class="p-6 text-white">
                        <div class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center mb-4 text-lg font-bold">
                            E
                        </div>
                        <a href="<?= BASE_URL ?>/servicos-financeiros/produtos-financeiros-sustentaveis"><h3 class="text-xl font-bold mb-2 group-hover:text-orange-400 transition">Produtos Financeiros Sustentáveis</h3></a>
                    </div>
                </div>
                ...
                <div class="bg-[#3E322D] rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition group">
                    <div class="h-48 bg-[#3E322D] flex items-center justify-center relative overflow-hidden">
                        <div class="absolute inset-0 bg-black/20"></div>
                        <div class="text-white text-6xl relative z-10"><img src="<?= BASE_URL ?>/imagens/esg-em-analise-de-credito.jpg" alt="ESG em Análise de Crédito" title="ESG em Análise de Crédito"></div>
                    </div>
                    <div class="p-6 text-white">
                        <div class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center mb-4 text-lg font-bold">
                            S
                        </div>
                        <a href="<?= BASE_URL ?>/servicos-financeiros/esg-em-analise-de-credito"><h3 class="text-xl font-bold mb-2 group-hover:text-orange-400 transition">ESG em Análise de Crédito</h3></a>
                    </div>
                </div>
                ...
                <div class="bg-[#3E322D] rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition group">
                    <div class="h-48 bg-[#3E322D] flex items-center justify-center relative overflow-hidden">
                        <div class="absolute inset-0 bg-black/20"></div>
                        <div class="text-white text-6xl relative z-10"><img src="<?= BASE_URL ?>/imagens/consultoria-esg-para-investidores.jpg" alt="Consultoria ESG para Investidores" title="Consultoria ESG para Investidores"></div>
                    </div>
                    <div class="p-6 text-white">
                        <div class="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center mb-4 text-lg font-bold">
                            G
                        </div>
                        <a href="<?= BASE_URL ?>/servicos-financeiros/consultoria-esg-para-investidores"><h3 class="text-xl font-bold mb-2 group-hover:text-orange-400 transition">Consultoria ESG para Investidores</h3></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
                <div>
                    <div class="rounded-xl overflow-hidden shadow-2xl">
                        <img src="<?= BASE_URL ?>/imagens/img-plataform.png" alt="Dashboard da plataforma" class="w-full h-auto">
                    </div>
                </div>
    ...
    <!-- Contato -->
    <?php include ROOT . '/includes/section-contato.php'; ?>
